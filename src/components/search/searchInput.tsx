...
export const SearchInput = () => {
  return (
  <div className="bg-white py-5 px-2 absolute top-26 md:-top-10 right-0 
  shadow-lg sm:shadow-none w-full md:bg-transparent md-w-full">
